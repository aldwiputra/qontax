          ...
          <div className='relative max-w-screen-xl mx-auto px-8 py-6 '>
            <div className='max-w-4xl mx-auto'>
              <div className=' text-gray-400 flex gap-3 items-center'>
                ...
                <h1 className={`${jakarta.className} text-2xl sm:text-4xl font-bold`}>Contact List</h1>
              </div>
              <ul className='mt-8 grid auto-fit gap-4 '>
                ...
                <Link
                  href='/contacts/new'
                  className='rounded-lg flex items-center justify-center border-2 py-10 border-dashed border-gray-400 text-gray-400 hover:bg-gray-400/10'>
