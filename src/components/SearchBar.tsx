    ...
    <form className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2' autoComplete='off'>
      ...
      <div className='relative'>
        ...
        <input
          ...
          required
        />
        <div className='invisible peer-focus:visible transition-all flex items-center gap-1  text-white absolute right-2 top-1/2 -translate-y-1/2  focus:ring-4 focus:outline-none font-medium rounded-lg text-xs px-4 py-1.5 bg-slate-500'>
          <svg
