...
function AuthButton({ status }: AuthButtonProps) {
        ...
        <button
          ...
          {loading ? (
            <svg
              aria-hidden='true'
              role='status'
              className='inline w-4 h-4 mr-3 animate-spin text-gray-600'
              viewBox='0 0 100 101'
              fill='none'
              xmlns='http://www.w3.org/2000/svg'>
              <path
    ...
    return (
      <div className='flex'>
        <button
          disabled
          type='button'
          className='py-2.5 px-4 text-sm font-medium  rounded-lg border focus:z-10 focus:ring-4 outline-non bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-700 inline-flex items-center'>
          <svg
            aria-hidden='true'
            role='status'
            className='inline w-4 h-4 mr-3 animate-spin text-gray-600'
