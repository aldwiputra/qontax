  ...
  return (
    <li>
      <Link
        ...
        className='block rounded-lg p-4 border border-gray-700/75 shadow-lg shadow-gray-700/30 bg-gray-800 hover:bg-gray-700 hover-border-gray-600'>
        <div className='relative aspect-square max-w-[4rem]'>
          <img
